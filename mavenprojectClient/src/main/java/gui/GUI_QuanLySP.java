...
//    SanPhamImpl dsSP = new SanPhamImpl();
    ...
    private LoaiSanPham_DAO loai;
    private NhaCungCapDao ncc;

    public GUI_QuanLySP() throws java.rmi.RemoteException {
        try {
            dsSP = (SanPham_DAO) Naming.lookup(URL + "SanPham");
            loai = (LoaiSanPham_DAO) Naming.lookup(URL + "LoaiSanPham");
            ncc = (NhaCungCapDao) Naming.lookup(URL + "NhaCungCap");
    ...
    private void btnXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXoaActionPerformed
        ...
        try {
            ...
            if (row >= 0) {
                ...
                int option = JOptionPane.showConfirmDialog(null, "Bạn có muốn xóa sản phẩm này không?", "Xác nhận", JOptionPane.YES_NO_OPTION);
...
//        SanPhamImpl ds = new SanPhamImpl();
    ...
    private SanPham themSPFromTextFile() throws java.rmi.RemoteException {
//        SanPhamImpl ds = new SanPhamImpl();
        List<SanPham> list = dsSP.docTuBang();
    ...
    public boolean kiemTraText() {
        if (txtTenSP.getText().isEmpty()) {
            JOptionPane.showMessageDialog(null, "Tên sản phẩm không được để trống", "Thông báo lỗi", JOptionPane.ERROR_MESSAGE);
            return false;
        }
        if (txtSoLuong.getText().isEmpty()) {
            JOptionPane.showMessageDialog(null, "Số lượng không được để trống", "Thông báo lỗi", JOptionPane.ERROR_MESSAGE);
            return false;
        }
        try {
            int soLuong = Integer.parseInt(txtSoLuong.getText());
            if (soLuong < 0) {
                JOptionPane.showMessageDialog(this, "Số lượng phải từ 0 trở lên", "Thông báo", JOptionPane.INFORMATION_MESSAGE);
                return false;
            }
        } catch (Exception e) {
            JOptionPane.showMessageDialog(this, "Số lượng phải là số", "Thông báo", JOptionPane.INFORMATION_MESSAGE);
            return false;
        }
        if (txtGiaNhap.getText().isEmpty()) {
            JOptionPane.showMessageDialog(null, "Giá nhập không được để trống", "Thông báo lỗi", JOptionPane.ERROR_MESSAGE);
            return false;
        }
        try {
            double giaNhap = Double.parseDouble(txtGiaNhap.getText());
            if (giaNhap <= 0) {
                JOptionPane.showMessageDialog(this, "Giá nhập phải lớn hơn 0", "Thông báo", JOptionPane.INFORMATION_MESSAGE);
                return false;
            }
        } catch (Exception e) {
            JOptionPane.showMessageDialog(this, "Giá nhập phải là số", "Thông báo", JOptionPane.INFORMATION_MESSAGE);
            return false;
        }
        if (txtGiaBan.getText().isEmpty()) {
            JOptionPane.showMessageDialog(null, "Giá bán không được để trống", "Thông báo lỗi", JOptionPane.ERROR_MESSAGE);
            return false;
        }
        try {
            double giaBan = Double.parseDouble(txtGiaBan.getText());
            if (giaBan <= 0) {
                JOptionPane.showMessageDialog(this, "Giá bán phải lớn hơn 0", "Thông báo", JOptionPane.INFORMATION_MESSAGE);
                return false;
            }
        } catch (Exception e) {
            JOptionPane.showMessageDialog(this, "Giá bán phải là số", "Thông báo", JOptionPane.INFORMATION_MESSAGE);
            return false;
        }
        double giaNhap = Double.parseDouble(txtGiaNhap.getText());
        double giaBan = Double.parseDouble(txtGiaBan.getText());
        if (giaNhap >= giaBan) {
            JOptionPane.showMessageDialog(this, "Giá nhập phải nhỏ hơn giá bán", "Thông báo", JOptionPane.INFORMATION_MESSAGE);
            return false;
        }
        return true;
    }
