...
public class GUI_QuanLyKhachHang extends javax.swing.JPanel {
     ...
     */
    KhachHang_DAO dsKhachHang;
//    KhachHangImpl dsKhachHang = new KhachHangImpl();
    DefaultTableModel dataModel;
    private static final String URL = RmiConfig.RMI_URL;

    public GUI_QuanLyKhachHang() throws java.rmi.RemoteException {
        try {
            dsKhachHang = (KhachHang_DAO) Naming.lookup(URL + "KhachHang");
        ...
        try {
            ...
            if (row >= 0) {
                if (kiemTraText()) {
                    ...
                    if (dsKhachHang.update(khCapNhap)) {
...
//        KhachHangImpl ds = new KhachHangImpl();
        List<KhachHang> list = dsKhachHang.docTuBang();
        String gt;
    ...
    private KhachHang themKHFromTextFile() throws java.rmi.RemoteException {
//        KhachHangImpl ds = new KhachHangImpl();
        List<KhachHang> list = dsKhachHang.docTuBang();
    ...
    public boolean kiemTraText() {
        ...
        if (txtSoDienThoai.getText().isEmpty()) {
            JOptionPane.showMessageDialog(null, "Sô điện thoại không được để trống", "Thông báo lỗi", JOptionPane.ERROR_MESSAGE);
            return false;
        }
        if (!txtSoDienThoai.getText().matches("^0[0-9]{9}$")) {
            JOptionPane.showMessageDialog(null, "Số điện thoại phải bắt đầu bằng 0 và có 10 chữ số", "Thông báo lỗi", JOptionPane.ERROR_MESSAGE);
            return false;
        }
        ...
        if (btnGroupGioiTinh.getSelection() == null) {
            JOptionPane.showMessageDialog(null, "Vui lòng chọn giới tính", "Thông báo lỗi", JOptionPane.ERROR_MESSAGE);
            return false;
        }
        return true;
    }
